...
#### 
Development Efficiency Business Group provides one stop shopping for the needs of developers, testers and operators. Our platform provides the source code repository, packaging and deployments to production environments for all businesses. These applications run on hundreds of thousands of servers. 
#### 
We are forming a compiler optimization team to scale the performance optimization to all the servers in our data centers. Through advanced compiler technologies, the team would reduce the cost of running group software applications by reducing the demand on the amount of the systems and resources. We believe this is an excellent opportunity for compiler developers. There are opportunities to save thousands of servers with just a small performance gain through better compiler technologies.
